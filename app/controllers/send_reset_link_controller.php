...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($stmt_insert->execute()) {
            ...
            $reset_link = "http://localhost:8080/" . BASE_URL . "app/views/auth/reset_password_view.php?token=" . $token;
            ...
            try {
                ...
                $mail->send();
                $_SESSION['message'] = "Reset link sent Successful!";
                header("Location: " . BASE_URL . "app/views/auth/forgot_password_view.php");
                exit();
            } catch (Exception $e) {
