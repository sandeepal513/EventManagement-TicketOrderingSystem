<?php
    ...
    // CRITICAL FIX: REMOVED HARDCODED USER ID
    // This line was a major security vulnerability - it forced all users to be user_id = 1
    $_SESSION['user_id'] = 1;  // REMOVED THIS LINE
    ...
    if ($user['role'] == 'admin') {
        ...
        include_once ROOT . '/app/views/user/profile_user.php';
    } elseif ($user['role'] == 'organizer') {
        include_once ROOT . '/app/views/organizer/profile_organizer.php';
    } else {
