    ...
    <div class="card shadow-lg border-0 rounded-4 mb-5 mx-auto" style="max-width: 900px;">
        <div class="card-body p-md-5 p-4">
            ...
            <form method="POST" enctype="multipart/form-data" class="row g-4">
                ...
                <div class="col-md-6">
                     <label class="form-label text-muted fw-high">Organizer ID:</label>
                        <select name="organizer_id" class="form-select form-control <?= isset($errors['organizer_id']) ? 'is-invalid' : '' ?>" >
                        <option value="">Select Organizer</option>
                            <?php 
                            // Fetch all users with the 'organizer' role
                            $organizers_res = $conn->query("SELECT * FROM users WHERE role = 'organizer'");
                                                                                                                                                            
                            // Loop through each user and display as an option
                            while ($organizer = $organizers_res->fetch_assoc()):
                            ?>
                        <option value="<?= $organizer['user_id'] ?>" 
                        <?= isset($edit_row['organizer_id']) && $edit_row['organizer_id'] == $organizer['user_id'] ? 'selected' : '' ?>>
                        ...
                        <?php if (isset($errors['organizer_id'])): ?>
                            <div class="invalid-feedback">
                                <?= htmlspecialchars($errors['organizer_id']) ?>
                            </div>
                        <?php endif; ?>
                </div>
                ...
                <div class="col-12">
                    ...
                    <?php if(!empty($edit_row['image_url'])): ?>
                        <div class="mt-3">
                            ...
                            <img src="<?= $edit_row['image_url'] ?>" class="img-thumbnail rounded-3" alt="Event Image Preview" style="max-width: 200px;">
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="col-12 d-flex justify-content-center gap-3 pt-3">
                    ...
                    <a href="event.php" class="btn btn-outline-secondary btn px-5">
                        Cancel
                    </a>
                </div>
            </form>
                   ...
                   class="text-decoration-none text-dark card-link-wrapper">
                    ...
                    <div class="card event-card shadow-md border-0 rounded-4 overflow-hidden h-100">
                        ...
                        <div class="card-body p-4">
                            ...
                            <a href="event.php?edit=<?= $row['event_id'] ?>" 
