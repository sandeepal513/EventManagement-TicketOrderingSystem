<?php
    ...
    $profile_page = match ($role) {
        'admin' => './../pages/profile_admin.php',
        'organizer' => './../pages/profile_organizer.php',
        default => './../pages/profile_user.php',
    };
    ...
    // Check for database connection failure (should be handled in connection.php, but check again)
    if (!$conn) {
    ...
    // B. Update details AND password (All password fields must be filled)
        ...
        // 1. Fetch current hashed password securely (CRITICAL STEP)
        ...
        // Added check for non-empty password hash before calling password_verify
        ...
        // If all checks pass, proceed with update
            ...
            $hashed_pwd = password_hash($new_pwd, PASSWORD_DEFAULT); // Use PASSWORD_DEFAULT for best practice
    ...
    // --- FINAL REDIRECTION (FIXED) ---
    // This line is mandatory to send the user back to the profile page 
