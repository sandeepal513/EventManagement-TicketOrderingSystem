...
function deleteProfileImage(event) {
    console.log('deleteProfileImage function called');
    event.preventDefault(); // Prevent the default link action
    event.stopPropagation(); // Stop the event from bubbling up

    console.log('About to show delete confirmation modal');
...
function showDeleteConfirmationModal() {
    console.log('showDeleteConfirmationModal function called');
    // Create modal HTML
    ...
    // Trigger animation
    setTimeout(() => {
        console.log('Adding is-visible class to modal');
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', () => {
        console.log('Confirm delete button clicked, redirecting to delete controller');
        closeDeleteConfirmationModal(confirmModal);
